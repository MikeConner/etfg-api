...
ActiveRecord::Schema.define(version: 2019_07_04_170023) do
  ...
  create_table "basket_funds", force: :cascade do |t|
    t.date "run_date", null: false
    t.date "as_of_date"
    ...
    t.index ["composite_ticker"], name: "index_basket_funds_on_composite_ticker"
    t.index ["run_date", "composite_ticker"], name: "index_basket_funds_on_run_date_and_composite_ticker"
    t.index ["run_date"], name: "index_basket_funds_on_run_date"
  end

  create_table "basket_holdings", force: :cascade do |t|
    t.date "run_date", null: false
    t.date "as_of_date"
    t.string "composite_ticker", limit: 32, null: false
    t.string "exchange_country", limit: 16, null: false
    ...
    t.index ["run_date", "constituent_ticker"], name: "index_basket_holdings_on_run_date_and_constituent_ticker"
